...
| --------- | --------------- | ------------ | --------- |
| SITE1_BORDER_LEAF1 | Vlan4094 | 10.1.6.9 | Port-Channel1 |
...
| Ethernet4 | s1-brdr1_Ethernet2 | *trunk | *none | *- | *- | 4 |
| Ethernet5 | s1-brdr2_Ethernet2 | *trunk | *none | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet7 | routed | - | 10.1.2.33/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet7 | routed | - | 10.1.2.35/31 | default | 9000 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.3.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.4.5/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.0.10.69/32 |
| Loopback102 | GREEN_VTEP_DIAGNOSTICS | GREEN | 10.0.10.133/32 |
| Loopback103 | RED_VTEP_DIAGNOSTICS | RED | 10.0.10.5/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf BLUE
   ip address 10.0.10.69/32
!
interface Loopback102
   description GREEN_VTEP_DIAGNOSTICS
   no shutdown
   vrf GREEN
   ip address 10.0.10.133/32
!
...
| Vlan801 |  BLUE  |  10.3.1.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan802 |  GREEN  |  10.3.2.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan803 |  RED  |  10.3.3.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan811 |  BLUE  |  10.4.1.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan812 |  GREEN  |  10.4.2.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan813 |  RED  |  10.4.3.3/29  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.1.5.8/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.6.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.1.2.32 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.1.2.34 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.1.5.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
| 10.3.1.2 | 65121 | BLUE | - | - | - | - | - | - |
| 10.4.1.2 | 65121 | BLUE | - | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| BLUE | 10.1.3.5:501 | 501:501 | - | - | learned | 101,801,811 |
| GREEN | 10.1.3.5:502 | 502:502 | - | - | learned | 202,802,812 |
| RED | 10.1.3.5:503 | 503:503 | - | - | learned | 303,803,813 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.1.3.5:501 | connected |
| GREEN | 10.1.3.5:502 | connected |
| RED | 10.1.3.5:503 | connected |
...
router bgp 65113
   ...
   neighbor 10.1.2.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.2.32 remote-as 65101
   neighbor 10.1.2.32 description s1-spine1_Ethernet7
   neighbor 10.1.2.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.2.34 remote-as 65101
   neighbor 10.1.2.34 description s1-spine2_Ethernet7
   neighbor 10.1.5.9 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.5.9 description s1-brdr2
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.0.10.69
ip address virtual source-nat vrf GREEN address 10.0.10.133
ip address virtual source-nat vrf RED address 10.0.10.5
```
