...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | S2-LEAF1_Ethernet4 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | S2-LEAF2_Ethernet4 | *trunk | *none | *- | *- | 1 |
...
!
interface Ethernet1
   description S2-LEAF1_Ethernet4
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description S2-LEAF2_Ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SITE2_DC_LEAF1_Po4 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel1
   description SITE2_DC_LEAF1_Po4
   no shutdown
   switchport
