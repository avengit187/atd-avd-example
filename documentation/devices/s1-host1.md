...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | S1-LEAF1_Ethernet4 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | S1-LEAF2_Ethernet4 | *trunk | *none | *- | *- | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SITE1_DC_LEAF1_Po4 | switched | trunk | none | - | - | - | - | - | - |
...
interface Port-Channel1
   description SITE1_DC_LEAF1_Po4
   no shutdown
   switchport
