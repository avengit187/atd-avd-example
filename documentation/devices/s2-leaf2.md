...
| --------- | --------------- | ------------ | --------- |
| SITE2_DC_LEAF1 | Vlan4094 | 10.2.6.0 | Port-Channel1 |
...
| Ethernet4 | S2-HOST1_Ethernet2 | *trunk | *none | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 10.2.2.9/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 10.2.2.11/31 | default | 9000 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.3.2/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.4.1/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.0.10.98/32 |
| Loopback102 | GREEN_VTEP_DIAGNOSTICS | GREEN | 10.0.10.162/32 |
| Loopback103 | RED_VTEP_DIAGNOSTICS | RED | 10.0.10.34/32 |
...
| 10.2.2.8 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.2.2.10 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| BLUE | 10.2.3.2:501 | 501:501 | - | - | learned | 101 |
| GREEN | 10.2.3.2:502 | 502:502 | - | - | learned | 202 |
| RED | 10.2.3.2:503 | 503:503 | - | - | learned | 303 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.2.3.2:501 | connected |
| GREEN | 10.2.3.2:502 | connected |
| RED | 10.2.3.2:503 | connected |
...
router bgp 65211
   ...
   neighbor 10.2.2.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.2.8 remote-as 65201
   neighbor 10.2.2.8 description s2-spine1_Ethernet3
   neighbor 10.2.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.2.10 remote-as 65201
   neighbor 10.2.2.10 description s2-spine2_Ethernet3
   neighbor 10.2.5.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.2.5.0 description s2-leaf1
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.0.10.98
ip address virtual source-nat vrf GREEN address 10.0.10.162
ip address virtual source-nat vrf RED address 10.0.10.34
```
