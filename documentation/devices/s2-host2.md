...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | default | 192.168.0.27/24 | 192.168.0.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | S2-LEAF3_Ethernet4 | *trunk | *none | *- | *- | 1 |
| Ethernet2 | S2-LEAF4_Ethernet4 | *trunk | *none | *- | *- | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SITE2_DC_LEAF2_Po4 | switched | trunk | none | - | - | - | - | - | - |
