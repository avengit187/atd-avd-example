...
| --------- | --------------- | ------------ | --------- |
| SITE2_DC_LEAF1 | Vlan4094 | 10.2.6.1 | Port-Channel1 |
...
!
mlag configuration
   domain-id SITE2_DC_LEAF1
   local-interface Vlan4094
   peer-address 10.2.6.1
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf2_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet4 | S2-HOST1_Ethernet1 | *trunk | *none | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s2-leaf2_Ethernet6 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet2 | routed | - | 10.2.2.1/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet2 | routed | - | 10.2.2.3/31 | default | 9000 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s2-leaf2_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel4 | S2-HOST1_Po1 | switched | trunk | none | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.3.1/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.4.1/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.0.10.97/32 |
| Loopback102 | GREEN_VTEP_DIAGNOSTICS | GREEN | 10.0.10.161/32 |
| Loopback103 | RED_VTEP_DIAGNOSTICS | RED | 10.0.10.33/32 |
...
| 10.2.2.0 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.2.2.2 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| BLUE | 10.2.3.1:501 | 501:501 | - | - | learned | 101 |
| GREEN | 10.2.3.1:502 | 502:502 | - | - | learned | 202 |
| RED | 10.2.3.1:503 | 503:503 | - | - | learned | 303 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.2.3.1:501 | connected |
| GREEN | 10.2.3.1:502 | connected |
| RED | 10.2.3.1:503 | connected |
...
router bgp 65211
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65211
   ...
   neighbor 10.2.2.0 remote-as 65201
   neighbor 10.2.2.0 description s2-spine1_Ethernet2
   neighbor 10.2.2.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.2.2 remote-as 65201
   neighbor 10.2.2.2 description s2-spine2_Ethernet2
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.0.10.97
ip address virtual source-nat vrf GREEN address 10.0.10.161
ip address virtual source-nat vrf RED address 10.0.10.33
```
