...
| --------- | --------------- | ------------ | --------- |
| SITE1_DC_LEAF1 | Vlan4094 | 10.1.6.0 | Port-Channel1 |
...
| Ethernet4 | S1-HOST1_Ethernet2 | *trunk | *none | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet3 | routed | - | 10.1.2.9/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet3 | routed | - | 10.1.2.11/31 | default | 9000 | false | - | - |
...
| Port-Channel4 | S1-HOST1_Po1 | switched | trunk | none | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.3.2/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.4.1/32 |
| Loopback101 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.0.10.66/32 |
| Loopback102 | GREEN_VTEP_DIAGNOSTICS | GREEN | 10.0.10.130/32 |
| Loopback103 | RED_VTEP_DIAGNOSTICS | RED | 10.0.10.2/32 |
...
| Vlan4093 |  default  |  10.1.5.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.6.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.1.2.8 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.1.2.10 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 10.1.5.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| BLUE | 10.1.3.2:501 | 501:501 | - | - | learned | 101 |
| GREEN | 10.1.3.2:502 | 502:502 | - | - | learned | 202 |
| RED | 10.1.3.2:503 | 503:503 | - | - | learned | 303 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.1.3.2:501 | connected |
| GREEN | 10.1.3.2:502 | connected |
| RED | 10.1.3.2:503 | connected |
...
router bgp 65111
   ...
   neighbor 10.1.2.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.2.8 remote-as 65101
   neighbor 10.1.2.8 description s1-spine1_Ethernet3
   neighbor 10.1.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.2.10 remote-as 65101
   neighbor 10.1.2.10 description s1-spine2_Ethernet3
   neighbor 10.1.5.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.5.0 description s1-leaf1
...
ip address virtual source-nat vrf RED address 10.0.10.2
```
